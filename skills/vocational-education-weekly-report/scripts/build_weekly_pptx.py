...
def self_test_spec() -> dict[str, Any]:
    ...
    return {
        ...
        "weekly_judgment": "本期样例覆盖职业教育政策、院校和企业进展，事项均包含明确时间、主体、公开事实和行业影响。报告按栏目同步正式进展，并通过来源、评分和报告期门槛排除检索过程、空结果与低价值信息。各事项的院校影响、企业参与和主要风险均有公开依据，外发内容聚焦已经发生的变化，使读者可以快速了解行业进展。",
        "quality_review": {
